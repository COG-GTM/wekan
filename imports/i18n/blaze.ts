...
// Blaze passes a helper's positional args followed by a Spacebars options/kw
// object, so the argument list is genuinely arbitrary here.
Blaze.registerHelper('_', (...args: any[]) => {
