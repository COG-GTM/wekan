 ...
 * @returns {boolean}
 */
export function isSelectedSubtaskList(board: SubtaskBoard | null | undefined, listId: string | null | undefined) {
  const b: SubtaskBoard = board || {};
 ...
 * @returns {boolean}
 */
export function isSelectedSubtaskBoard(board: SubtaskBoard | null | undefined, boardId: string | null | undefined) {
  const b: SubtaskBoard = board || {};
